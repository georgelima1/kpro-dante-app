...
export default function SpeakerPresetFilterPage() {
  ...
  const dragCommitRef = useState<{ id: number | null; patch: Partial<SpeakerFilter> }>({
    id: null,
    patch: {}
  })[0];
  ...
  function renderSummary(f: SpeakerFilter) {
      ...
      <section className="bg-smx-panel border border-smx-line rounded-2xl overflow-hidden">
        <div className="px-5 py-4 border-b border-smx-line flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="text-base font-semibold">Speaker Filters</div>
            <div className="text-sm md:text-xs text-smx-muted">
              CH {ch} • Speaker EQ and crossovers
            </div>
          </div>
        </div>
                    ...
                    {!isFixedCrossoverBand && (
                      <div className="w-full md:w-[300px]">
                        <Select
                          ...
                          onChange={(type) => {
                            const patch: Partial<SpeakerFilter> = { type };
                      ...
                      <div className="w-full md:w-[300px]">
                        <Select
                          ...
                          onChange={(value) => {
                            ...
                            const slope = Number(slopeStr) as SpeakerFilter["slope"];
